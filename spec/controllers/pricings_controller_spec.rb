  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:pricing => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested pricing" do
        pricing = Pricing.create! valid_attributes
        put :update, {:id => pricing.to_param, :pricing => new_attributes}, valid_session
        pricing.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        pricing = Pricing.create! valid_attributes
        put :update, {:id => pricing.to_param, :pricing => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
